document.addEventListener("DOMContentLoaded", () => {
  ...
  navContentLarge.innerHTML = '<li class="nav-item"><a class="nav-link home" href="index.html">Home</a></li><li class="nav-item mx-3"><a class="nav-link list" href="list-of-smart-guys.html">List of smart guys</a></li><li class="nav-item"><a class="nav-link disabled" href="#">Help</a></li>';
  
  let navContentSmall = document.createElement('div');
  navContentSmall.classList.add('pos-f-t', 'd-flex', 'flex-column', 'align-items-end');
  navContentSmall.innerHTML = '<div class="pos-f-t d-flex flex-column align-items-end"><nav class="navbar-dark bg-primary"><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button></nav><div class="collapse mt-1" id="navbarToggleExternalContent"><div class="bg-primary p-2"><ul class="navbar-nav d-flex flex-column align-items-end mt-2"><li class="nav-item mb-2"><a class="nav-link home" href="index.html">Home</a></li><li class="nav-item mb-2"><a class="nav-link list" href="list-of-smart-guys.html">List of smart guys</a></li><li class="nav-item"><a class="nav-link disabled" href="#">Help</a></li></ul></div></div></div>';
